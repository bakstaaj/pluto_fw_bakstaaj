...
```text
release-packages/bakstaaj-v0.39-bakstaaj.2a-release.zip
  sdcard/bakstaaj-v0.39-bakstaaj.2a-sdcard.img
  sdcard/bakstaaj-v0.39-bakstaaj.2a-sdcard-files.zip
  sdcard/sdimg/
```
...
4. Select `sdcard/bakstaaj-v0.39-bakstaaj.2a-sdcard.img` from the extracted release.
...
- The serial login banner reports `device-fw v0.39-bakstaaj.2a`.
...
2. Extract `sdcard/bakstaaj-v0.39-bakstaaj.2a-sdcard-files.zip`.
