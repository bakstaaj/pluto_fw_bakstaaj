...
```text
release-packages/bakstaaj-v0.39-bakstaaj.2d-release.zip
  sdcard/bakstaaj-v0.39-bakstaaj.2d-sdcard.img
  sdcard/bakstaaj-v0.39-bakstaaj.2d-sdcard-files.zip
  sdcard/sdimg/
```
...
4. Select `sdcard/bakstaaj-v0.39-bakstaaj.2d-sdcard.img` from the extracted release.
...
- The serial login banner reports `device-fw v0.39-bakstaaj.2d`.
...
2. Extract `sdcard/bakstaaj-v0.39-bakstaaj.2d-sdcard-files.zip`.
